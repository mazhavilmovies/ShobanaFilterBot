class script(object):
    START_TXT = """ Hᴇʟʟᴏ {}.𝖨 𝖠𝗆 Sandeep 
🎥, 𝖧𝖺𝗉𝗉𝗒 🖤 𝖳𝗈 𝖧𝖺𝗏𝖾 𝖸𝗈𝗎

Here You Can Request Movie's, 
Just Sent Movie Name With Proper Google Spelling..!!

Cᴏɴᴛᴀᴄᴛ Bᴏᴛ Dᴇᴠᴇʟᴏᴘᴇʀ (Oʀ) Rᴇᴘᴏʀᴛ Bᴜɢꜱ..!! 👉 @iMazhavilAdminBot"""
    HELP_TXT = """
     Hey  {} 
