...
BOT_TOKEN = environ.get('BOT_TOKEN', '7958982854:AAHX2JfP28V9QZS2UBYAVFHXP0-gIBQ_BXI')

# Keep-Alive URL
KEEP_ALIVE_URL = environ.get("KEEP_ALIVE_URL", "https://shobanafilterbot-fo76.onrender.com")  # <-- Add this line
#hyper link
...
PICS = (environ.get('PICS', 'https://graph.org/file/7d9dc46a6eccf19d8f1c4-c8fe2fc1656722e5ea.jpg https://graph.org/file/8e1ed661b03c132412c41-cba520bd2ecaf1c87a.jpg https://graph.org/file/eb0422fb117098f6cf028-d584072a3012e9fb3c.jpg')).split()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1933114137 5020503671').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002833936259').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_grp = environ.get('AUTH_GROUP')
DEFAULT_AUTH_CHANNELS = [int(x) for x in environ.get("AUTH_CHANNEL", "-1002772960825").split() if x.lstrip('-').isdigit()]
...
FILE_CHANNELS = [int(ch) for ch in environ.get('FILE_CHANNELS', '-1002642530472').split()]
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002984004301'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1002995624443')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003071824692')).split()]
